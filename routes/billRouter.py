...
@router.post("/", dependencies=[Depends(require_role(["admin", "nurse"]))], response_model=Bill)
...
@router.get("/all", dependencies=[Depends(require_role(["admin", "nurse"]))], response_model=list[Bill])
...
@router.get("/{id_bill}", dependencies=[Depends(require_role(["admin", "nurse"]))], response_model=Bill)
...
@router.put(
    "/update/{id_bill}", dependencies=[Depends(require_role(["admin", "nurse"]))], response_model=Bill
)
...
@router.delete(
    "/delete/{id_bill}", dependencies=[Depends(require_role(["admin", "nurse"]))], response_model=Bill
)
