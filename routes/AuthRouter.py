...
from schemas.auth_schema import LoginRequest, UserResponse, LoginResponse
...
async def login(login: LoginRequest, db: SessionLocal = Depends(get_db)):
    try:
        ...
        return LoginResponse(access_token=access_token, token_type="bearer", user=UserResponse(
